package _1.vietpq.job_hunter.config.database;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public DatabaseInitializer(UserRepository userRepository, RoleRepository roleRepository, PermissionRepository permissionRepository, PasswordEncoder passwordEncoder) {
